<?php
/**
 * Wedia Affiliates Theme functions and definitions
 *
 * @link https://developer.wordpress.org/themes/basics/theme-functions/
 *
 * @package WordPress
 * @subpackage Wedia Affiliates
 * @since Wedia Affiliates 1.0
 */
...
function enqueue_anchor_link_script() {
	...
	wp_enqueue_script( 'slider_js', get_template_directory_uri() . '/js/hero-slider.js', array(), '1.0', true );
}
...
// This function takes the post ID as an argument and 
// retrieves the categories assigned to the post using 
// get_the_terms(). It then loops through the categories 
// and adds their ID to an array. Finally, it returns the 
// term object for the last category in the array, which 
