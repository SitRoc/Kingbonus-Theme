<?php /* Template Name: News/Search Listing*/ ?>
<?php get_header(); ?>
<div id="site-wrapper">
               ...
               <section>
                  <div class="wp-block-columns has-background" style="background-color:#f5f5f5">
                     ...
                     <div class="wp-block-column">
                        ...
                        <span class="post-info"><?php the_field('search_category_listing_label_field', 'option'); ?> | <?php echo get_the_date(); ?> | <?php the_category(' , '); ?></span>
                        <?php the_excerpt();?>
                     </div>
                  </div>
               </section>
