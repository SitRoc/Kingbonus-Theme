...
<li>
    <div class="fe-odd">
        ...
        <div class="odd-content">
            ...
            <div class="odd-cta"><a href="<?php echo $casino_link; ?>" class="button" target="_blank" rel="nofollow">Spill her</a>
            </div>
        </div>
		<div class="odd-read-less">
            <a href="" class="read-less-link">Lukk</a>
        </div>
        <div class="odd-read-more">
            <a href="" class="read-more-link">Les mer</a>
        </div>
    </div>
</li>
<?php
