...
<div class="box box-full">
      <section  id="<?php the_ID(); ?>" >
         ...
         <div class="casin-bonus-info"><div class="sub-info">
			 <span class="sub-info-title">BONUS</span>
            ...
            <div class="sub-info">
               <span class="sub-info-title">SPESIAL</span>
               <span class="sub-info-content"><?php echo $details['c_detail_3'];?></span>
            </div>
         </div>
         <a href="<?php the_field('c_link'); ?>" title="Hent bonus fra <?php the_title(); ?>" target="_blank" class="button-3" rel="nofollow">Hent Bonus</a>
      </section>
   </div>