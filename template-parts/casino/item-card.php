...
<div class="box box-full">
      <section  id="<?php the_ID(); ?>" >
         ...
         <div class="casin-bonus-info">
            <em><?php echo $infoBox1Title; ?> &mdash;</em>  <?php echo $infoBox1Data;?> <em>& <?php echo $infoBox2Title; ?> &mdash;</em> <?php echo $infoBox2Data;?> <em>& <?php echo $infoBox3Title; ?> &mdash; </em> <?php echo $infoBox3Data;?> <em>& <?php echo $infoBox4Title; ?> &mdash; </em> <?php echo $infoBox4Data;?>
         </div>
         <a href="<?php echo $Link; ?>" title="Hent bonus fra <?php the_title(); ?>" target="_blank" class="button-3" rel="nofollow">Hent Bonus</a>
         <span>18+ | Terms Apply | Play Responsibly</span>
      </section>
   </div>