...
<?php $Odds= get_post_meta($post->ID, 'Odds', true); ?>
    ...
    <tr class="main slim-row" id="row-<?php echo $post->ID; ?>">
        ...
        <td class="title vanish-mobile twoninth">
        ...
        <td class="vanish-mobile ninth info prosent">
            <h4><?php echo $Percentage;?></h4>
        </td>
        <td class="vanish-mobile ninth info opptil">
            <h4><?php echo $Bonus;?></h4>
        </td>
        <td class="vanish-mobile ninth info freespins">
            <h4><?php echo $Freespins;?></h4>
        </td>
        <td class="vanish-mobile ninth info wager">
